...
tags = make_tags(weight[:50], minsize=50, maxsize=100)
create_tag_image(tags, 'tags.png', size=(1500,1500), background=(0, 0, 0, 255), layout=LAYOUT_MIX, fontname='Molengo', rectangular=True)
import webbrowser
